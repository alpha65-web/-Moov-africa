    ...
    <div className="flex flex-col gap-6 pb-8">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input value={search} onChange={(e) => setSearch(e.target.value)} onKeyDown={searchKeyHandler(setSearch)} placeholder={t("columns.offerId") + ", " + t("columns.system") + "..."} className="input w-full h-10 pl-9" />
        </div>
