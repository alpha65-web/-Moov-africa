  ...
  return (
    <div className="flex flex-col gap-6 pb-8">
      ...
      <div className="rounded-2xl border border-border dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-card overflow-hidden">
        <div className="hidden md:grid grid-cols-[1.3fr_1fr_100px_120px_110px_60px] gap-4 px-6 py-3 bg-neutral-50 dark:bg-neutral-800/40 border-b border-border dark:border-neutral-800 rounded-t-2xl">
          {[t("columns.name"), t("columns.channel"), t("columns.status"), t("columns.scheduled"), t("columns.created"), t("columns.actions")].map((col, i) => (
            <span key={i} className={`text-[11px] font-semibold uppercase tracking-wider text-text-secondary dark:text-neutral-400 flex items-center gap-1 ${i === 5 ? "justify-end" : ""}`}>
              {col}
