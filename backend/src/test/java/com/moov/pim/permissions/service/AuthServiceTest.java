...
class AuthServiceTest {
    ...
    void register_shouldCreateUser() {
        RegisterRequest request = new RegisterRequest(
                "nouveau@moov.bf", "password12345", "Nouveau", "Utilisateur", "M", null, null, null, "CHEF_PRODUIT");
    ...
    void register_shouldThrowIfEmailExists() {
        RegisterRequest request = new RegisterRequest(
                "existant@moov.bf", "password12345", "A", "B", "M", null, null, null, "CHEF_PRODUIT");
    ...
    void register_shouldThrowIfRoleNotFound() {
        RegisterRequest request = new RegisterRequest(
                "new@moov.bf", "password12345", "A", "B", "M", null, null, null, "CHEF_PRODUIT");
