...
class AuditEventListenerTest {
    ...
    void onOfferTransition_shouldLogPublish() {
        UUID offerId = UUID.randomUUID();
        UUID userId = UUID.randomUUID();
        var event = new OfferTransitionEvent(offerId, "Offre B", userId, UUID.randomUUID(), "VALIDATED", "PUBLISHED", null);
    ...
    void onOfferTransition_shouldLogRejectForWithdrawn() {
        UUID offerId = UUID.randomUUID();
        UUID userId = UUID.randomUUID();
        var event = new OfferTransitionEvent(offerId, "Offre C", userId, UUID.randomUUID(), "IN_VALIDATION", "WITHDRAWN", null);
